...
DB = "shop.db"
UPLOAD_DIR = "uploads"
ADMIN_TOKEN = os.getenv("ADMIN_TOKEN", "Cobbyrock")
...
app = FastAPI(title="COBBYS Logistices API")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_methods=["*"], allow_headers=["*"])

# ---------------- seed data ----------------
SEED = [
    ("car","Toyota Corolla 2022 (Hybrid)",14500,"Low mileage, accident-free. Shipping worldwide."),
    ("car","BYD Dolphin EV 2023",16800,"Electric, 420km range, brand new from factory."),
    ("car","Toyota Hiace Van 2021",22400,"14-seater diesel — shuttle business ready."),
    ("part","Ceramic Brake Pad Set (Front)",45,"Fits Toyota/Honda/Nissan. Bulk discount from 10 sets."),
    ("part","LED Headlight Assembly Pair",120,"Plug & play, 6000K."),
    ("part","Suspension Kit (Shocks + Bushes)",150,"Tough grade. 1-year warranty."),
]
